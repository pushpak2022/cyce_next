...
import famInfo from "../../../assets/images/about/children-2.png"
...
const SoftwareDownloadOne = () => {
  return (
    <div className={`${styles.voopoSoftware} poss--relative bg--white`}>
          ...
          <div className="row">
            <div className="col-12 col-md-7 col-lg-6">
              <div className={styles.content}>
                ...
                <div dangerouslySetInnerHTML={{ __html: softwareContent.content }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <div style={{ width: "45%", height: "100%" }} className={styles.shape1}>
        <img style={{ width: "100%" }} src={famInfo} alt="voopo voip" />
      </div>
    </div>
  )
}

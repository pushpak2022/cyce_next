...
const PrivacyPolicyContainer = ({ background }) => {
  return (
    <div className={`${styles.psContainer} position-relative bg--cart-11`}>
      <div className="container">
        <div className="elementor-widget-container">
          <div className="row">
            <p>
              Thank you for choosing to be part of our community at pod.io (“Company”, “we”, “us”, or “our”). We are
            ...
            <p>
              ...
              any terms in this privacy notice that you do not agree with, please discontinue use of our Services
              immediately.
            </p>
            <p>
            ...
            <p>
              ...
              system, language preferences, referring URLs, device name, country, location, information about who and
              when you use our&nbsp;Website&nbsp;and other technical information. This information is primarily needed
              to maintain the security and operation of our&nbsp;Website, and for our internal analytics and reporting
              purposes.
            </p>
            <p>&nbsp;</p>
            <p>
            ...
            <ul>
              <li>
                <i>Device Data.&nbsp;</i>We collect device data such as information about your computer, phone, tablet
                or other device you use to access the&nbsp;Website. Depending on the device used, this device data may
            ...
            <ul>
              <li>
                ...
                settings of the device you use to access the Website. For example, we may use GPS and other technologies
                ...
                disabling your Locations settings on your device. Note however, if you choose to opt out, you may not be
            ...
            <ul>
              ...
              <li>
                ...
                communications with each user’s consent.<p>&nbsp;</p>
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                secure (for example, for fraud monitoring and prevention).<p>&nbsp;</p>
              </li>
              <li>
                To enforce our terms, conditions and policies for business purposes, to comply with legal and regulatory
                requirements or in connection with our contract.<p>&nbsp;</p>
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <a>WHAT ARE YOUR PRIVACY RIGHTS</a>” below).<p>&nbsp;</p>
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                national security or law enforcement requirements).<p>&nbsp;</p>
              </li>
              <li>
            ...
            <ul>
              <li>
                Other Users. When you share personal information (for example, by posting comments, contributions or
                other content to the Website) or otherwise interact with public areas of the Website, such personal
                information may be viewed by all users and may be publicly made available outside the Website in
                perpetuity. If you interact with other users of our Website and register for our Website through a
                ...
                your activity, communicate with you within our Website, and view your profile.
              </li>
            </ul>
            <ol start="4">
            ...
            <p>
              ...
              list, profile picture as well as other information you choose to make public on such social media
              platform.
            </p>
            <p>
            ...
            <p>
              ...
              children under age 18, please contact us at support@pod.io.
            </p>
            <p>&nbsp;</p>
            <ol start="9">
            ...
            <p>
              <i>In Short:&nbsp;</i>&nbsp;
              <i>
                In some regions, such as the European Economic Area, you have rights that allow you greater access to
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at support@pod.io.</p>
            <p>&nbsp;</p>
            ...
            <p>
              ...
              to remove cookies or reject cookies, this could affect certain features or services of our Website. To
            ...
            <p>
              ...
              below. You will then be removed from the marketing email list – however, we may still communicate with
              you, for example to send you service-related emails that are necessary for the administration and use of
              your account, to respond to service requests, or for other non-marketing purposes. To otherwise opt-out,
              you may:
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;■&nbsp;&nbsp;Contact us using the contact information provided.</p>
            <p>&nbsp;</p>
            ...
            <p>If you have questions or comments about this notice, you may email us at support@pod.io.</p>
            <p>&nbsp;</p>
            ...
            <p>
              ...
              to review, update, or delete your personal information, please submit a request form by emailing
              support@pod.io. We will respond to your request within 30 days.
            </p>
          </div>
        </div>
      </div>

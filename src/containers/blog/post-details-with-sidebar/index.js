        ...
        <div className="row">
          <div
            className={`col-12 col-lg-9 col-xl-8 ${
              sidebarPosition && sidebarPosition === "left" ? "order-1 order-lg-2 offset-xl-1" : ""
            }`}
          >
            <div className={styles.blDetailsInner}>
              <div className={styles.thumb}>
                <img src={require("./../../../assets/images/blog/big-img.png")} alt="voip voopo" />
              </div>
              <div className={styles.blogContent}>
                <div className={styles.author}>
                  <img src={require("./../../../assets/images/blog/author.png")} alt="voip voopo" />
              ...
              <ul className={styles.blList}>
                <li>
                  <img src={require("./../../../assets/images/blog/list1.png")} alt="voip voopo" />
                </li>
                <li>
                  <img src={require("./../../../assets/images/blog/list2.png")} alt="voip voopo" />
                </li>
              </ul>
              <div className={styles.blogContent}>
          ...
          <div
            className={`col-12 col-lg-3 col-xl-3 sm__mt--40 md__mt--40 ${
              sidebarPosition && sidebarPosition === "left" ? "order-2 order-lg-1" : "offset-xl-1"
            }`}
          >
            <BlogSidebar />
          </div>

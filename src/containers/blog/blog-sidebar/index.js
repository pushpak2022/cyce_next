    ...
    <div className="voopoSidebar">
      ...
      <div className={`${styles.vpWidget} ${styles.recentPostWrap} mb--60`}>
        <Tab.Container defaultActiveKey="recent">
          <Nav variant="pills" className={`${styles.voopoNav} nav justify-content-center`}>
          ...
          <Tab.Content>
            <Tab.Pane eventKey="recent" className={styles.singleTabContent}>
              <div className={styles.recentPost}>
                <div className={styles.thumb}>
                  <Link to={process.env.PUBLIC_URL + "/blog-post"}>
                    <img src={require("./../../../assets/images/blog/s1.jpg")} alt="voopo voip" />
                  </Link>
                </div>
                <div className={styles.content}>
                  <h4>
                    <Link to={process.env.PUBLIC_URL + "/blog-post"}>Voopo Lounch their Business.</Link>
                  </h4>
              ...
              <div className={styles.recentPost}>
                <div className={styles.thumb}>
                  <Link to={process.env.PUBLIC_URL + "/blog-post"}>
                    <img src={require("./../../../assets/images/blog/s2.jpg")} alt="voopo voip" />
                  </Link>
                </div>
                <div className={styles.content}>
                  <h4>
                    <Link to={process.env.PUBLIC_URL + "/blog-post"}>Three things about voopo.</Link>
                  </h4>
              ...
              <div className={styles.recentPost}>
                <div className={styles.thumb}>
                  <Link to={process.env.PUBLIC_URL + "/blog-post"}>
                    <img src={require("./../../../assets/images/blog/s3.jpg")} alt="voopo voip" />
                  </Link>
                </div>
                <div className={styles.content}>
                  <h4>
              ...
              <div className={styles.recentPost}>
                <div className={styles.thumb}>
                  <Link to={process.env.PUBLIC_URL + "/blog-post"}>
                    <img src={require("./../../../assets/images/blog/s4.jpg")} alt="voopo voip" />
                  </Link>
                </div>
                <div className={styles.content}>
                  <h4>
                    <Link to={process.env.PUBLIC_URL + "/blog-post"}>Usefulness of VoIP in 2020.</Link>
                  </h4>
      ...
      <div className={`${styles.vpWidget} ${styles.banner} mb--60`}>
        <div className={styles.thumb}>
          <Link to={process.env.PUBLIC_URL + "/blog"}>
            <img src={require("./../../../assets/images/blog/banner.png")} alt="voopo voip" />
          </Link>
        </div>
      </div>
      {/* End Newsleter */}
